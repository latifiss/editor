...
import { useCreateArticleMutation } from '@/store/features/afrobeatsrep/article/articleAPI';
...
export default function CreateArticlePage() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      setTimeout(() => {
        router.push('/afrobeatsrep/articles');
      }, 1500);
          ...
          <div className="flex flex-col items-center w-full bg-transparent border border-[#e0e0e0] dark:border-neutral-800 rounded-lg p-4 md:p-6 space-y-6">
            ...
            <div className="w-full space-y-4">
              ...
              <p className="text-xs text-gray-500 dark:text-gray-400">
                Note: Setting this as headline will remove headline status from any existing headline article
              </p>
            </div>
