...
export default function ArticlesPage({ initialArticles }: ArticlesPageProps) {
  ...
  const { 
    ...
    skip: !!debouncedSearchTerm || !!categoryFilter
  });
  ...
  }, [debouncedSearchTerm, categoryFilter, refetchCategoryArticles, refetchArticles]);
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-6">
          <div>
            <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-100">
              {categoryFilter ? `${categoryFilter} Articles` : 'Articles'}
            </h1>
          ...
          <div className="flex gap-3 w-full md:w-auto">
            <Link href="/afrobeatsrep/create-article" passHref>
              <Button
