...
import { useCreateOpinionMutation } from '@/store/features/ghweb/opinion/opinionAPI';
...
export default function CreateOpinionArticlePage() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      await createOpinion(payload).unwrap();
      router.push('/ghweb/opinions');
      notify('Opinion article created successfully', 'success');
    } catch (err: any) {
