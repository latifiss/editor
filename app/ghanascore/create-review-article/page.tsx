...
import { useCreateReviewMutation } from '@/store/features/ghweb/review/reviewAPI';
...
export default function CreateReviewArticlePage() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      notify('Review article created successfully', 'success');
    } catch (err: any) {
